...
def load_data(): 
  ...
  #for dropdown we need label and value
      ...
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map", children=[   
          dcc.Tabs(id = "subtabs", value = "WorldMap",children = [   
              ...
              dcc.Tab(label="India Map tool", id="India", value="IndiaMap")   
                ...
                # all the below components are inside the main tab so all are avaiable in both subtab 1 and 2
...
def main():  # the main  execusion starts here
  load_data()   
