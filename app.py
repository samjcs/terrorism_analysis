...
import webbrowser  # used only to open the tab in the defualt brower u use

import dash # to create a ap and a dummy server to host the website
...
import dash_core_components as dcc  # to have advanced and easy to use components here graphs maps and dropdowns to be specifc

import plotly.graph_objects as go  # to generate figureres

import plotly.express as px   # to make the charts and graphs

from dash.exceptions import PreventUpdate  # to prevent exceptions
